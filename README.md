...
- [demo.ipynb](https://github.com/ZIYU-DEEP/post-quantum-cryptography-for-blockchain/blob/main/demo.ipynb): If you are just looking for one file demonstrating all, this is what you need.
- [qure.py](https://github.com/ZIYU-DEEP/post-quantum-cryptography-for-blockchain/blob/main/encryption.py): This file can be seen as a package providing encryption and decryption functions using KEM (Key Encapsulation Mechanism) and SKE (Symmetric Key Encryption).
- [encryption.py](https://github.com/ZIYU-DEEP/post-quantum-cryptography-for-blockchain/blob/main/encryption.py): Given the `user_id` and the user specified `private_key`, this file runs an KEM + SKE protocol. The encrypted information are stored in [json](https://github.com/ZIYU-DEEP/post-quantum-cryptography-for-blockchain/blob/main/database/leviathan/0.json) in our [database](https://github.com/ZIYU-DEEP/post-quantum-cryptography-for-blockchain/tree/main/database/), while user can hold an abstract of the information in another [local json file](https://github.com/ZIYU-DEEP/post-quantum-cryptography-for-blockchain/blob/main/database/leviathan/0_local.json), containing `user_id`, `key_id`, `kem_algo`, and `ciphertext_abs`.
- [transaction.py](https://github.com/ZIYU-DEEP/post-quantum-cryptography-for-blockchain/blob/main/transaction.py): This file implements the transaction, while the user only need to provide the information in the aforementioned [local json file](https://github.com/ZIYU-DEEP/post-quantum-cryptography-for-blockchain/blob/main/database/leviathan/0_local.json). The true private key is never transmitted.
...
python request.py --user_id leviathan\
                  ...
                  --root ./database
```
The command line operations above are also implemented in [demo.ipynb](https://github.com/ZIYU-DEEP/post-quantum-cryptography-for-blockchain/blob/main/demo.ipynb) through IPython interations.
